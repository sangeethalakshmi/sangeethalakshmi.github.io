            ...
            cellsRenderer: function (row, column, value, rowData) {
              ...
              if (rowData.edit == 1) {
                ...
                if (localStorage.getItem('usertype') == 'Super Admin') {
                  confirmbutton = '<div class="gridicons" style="margin: 15px 10px;"><a href="javascript:void(0)" onClick="confirmAppointmentConfirmDetails('+row+');" class="btn btn-default btn-sm"><i class="fa fa-times-circle-o"></i> Confirm</a></div>';
                }
              }
              leftcolumn +=image;
              leftcolumn += status;
