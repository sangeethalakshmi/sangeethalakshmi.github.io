...
<html>
    ...
    <body>
        <h2 style="margin-top:0px">Appointment_default_settings <?php echo $button ?></h2>
	    ...
	    <a href="<?php echo site_url('appointment_default_settings') ?>" class="btn btn-default">Cancel</a>
	</form>
    </body>
</html>