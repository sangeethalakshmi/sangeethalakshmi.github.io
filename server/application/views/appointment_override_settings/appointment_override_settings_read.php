...
<html>
    ...
    <body>
        <h2 style="margin-top:0px">Appointment_override_settings Read</h2>
        <table class="table">
	    ...
	    <tr><td></td><td><a href="<?php echo site_url('appointment_override_settings') ?>" class="btn btn-default">Cancel</a></td></tr>
	</table>
        </body>
</html>